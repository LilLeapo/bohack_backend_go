...
type Registration struct {
	...
	EventID          int64                   `json:"eventId"        gorm:"column:event_id;not null;uniqueIndex:uniq_registration_event_user_type,priority:1;index:idx_event_registrations_event_status,priority:1"`
	EventSlug        string                  `json:"eventSlug"      gorm:"-"`
	EventTitle       string                  `json:"eventTitle"     gorm:"-"`
	UserID           int                     `json:"userId"         gorm:"column:user_id;not null;uniqueIndex:uniq_registration_event_user_type,priority:2;index:idx_event_registrations_user_id"`
	RegistrationType string                  `json:"registrationType" gorm:"column:registration_type;type:varchar(50);not null;default:'participant';uniqueIndex:uniq_registration_event_user_type,priority:3;index:idx_event_registrations_type"`
	...
	Attendance       *AttendanceConfirmation `json:"attendance,omitempty" gorm:"-"`
